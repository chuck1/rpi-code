...
mpu_data	read()
{
	...
	int n = read(sockfd,&buf,sizeof(mpu_data));
	if(n != sizeof(mpu_data))
...
void AnimateScene(void)
{
	...
	a0[0] = (float)data.a[0] / (float)0x7FFF;
	a0[1] = (float)data.a[1] / (float)0x7FFF;
	a0[2] = (float)data.a[2] / (float)0x7FFF;
	...
	printf("%12f%8.2f%8.2f%8.2f%8.2f%8.2f%8.2f%8.2f%8.2f%8.2f\n",
			dt,
			a0[0],
			a0[1],
			a0[2],
	...
	/*
	printf("%12f%8.2f%8.2f%8.2f%8.2f%8.2f%8.2f%8.2f%8.2f%8.2f%8.2f%8.2f%8.2f\n",
			dt,
			a_trim[0],
			a_trim[1],
			a_trim[2],
...
void calibrate()
{
	...
	for(int i = 0; i < len; ++i) {
		...
		a[0] = (float)data.a[0] / (float)0x7FFF;
		a[1] = (float)data.a[1] / (float)0x7FFF;
		a[2] = (float)data.a[2] / (float)0x7FFF;
		
		a_sum += a;
	}
	a_trim = a_sum / (float)len;
